          ...
          {[
            {
              ...
              period: '/mois',
              desc: '1 logement',
              features: ['1 logement', 'Site de réservation', 'Sync iCal', 'Paiements Stripe', 'Emails automatiques'],
              cta: 'Commencer',
              popular: false,
              href: '/register',
            },
            {
              ...
              features: ['5 logements', 'Tout Solo inclus', 'Calendrier unifié', 'Photos illimitées', 'Support prioritaire'],
              cta: 'Choisir ce plan',
              popular: true,
              href: '/register',
            },
            {
              ...
              features: ['15 logements', 'Tout inclus', 'Sous-domaine perso', 'Tableau de bord avancé', 'Support téléphonique'],
              cta: 'Choisir ce plan',
              popular: false,
              href: '/register',
            },
